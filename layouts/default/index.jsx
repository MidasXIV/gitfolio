...
const Layout = ({ children, title }) => (
  <div>
    ...
    <header className="min-w-full flex flex-col md:flex-row justify-between">
      <div>
    ...
    <footer className="bottom-0 min-w-full flex flex-col md:flex-row uppercase font-mono font-semibold text-xs">
